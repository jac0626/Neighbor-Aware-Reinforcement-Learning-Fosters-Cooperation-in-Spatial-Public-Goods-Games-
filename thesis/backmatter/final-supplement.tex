...
本附录保留与第五章相同1200次留出测试对应的末段完整表、全程逐次分布和预定空间快照，不新增运行，也不增加主要统计比较。每种方法与环境均包含1000至1029号30个种子。

\input{figures/work2-final/tail-table.tex}
...
\caption{最终测试中同一预定种子1000的末轮真实动作，$r=4.4$、10\%持续失真。蓝色表示合作，灰色表示背叛；数值为末轮比例，与最后20\%窗口的均值不同。}
